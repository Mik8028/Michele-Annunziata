...
<!--[if mso]><table width="560" cellpadding="0" cellspacing="0"><tr><td width="113" valign="top"><![endif]-->


<!--[if mso]></td><td width="20"></td><td width="427" valign="top"><![endif]-->
<table cellpadding="0" cellspacing="0" align="center">
<tbody>
<tr>
<td width="427" align="left" class="esd-container-frame">
<table cellpadding="0" cellspacing="0" width="100%">
<tbody>
<tr>

<td align="right">
<a target="_blank"><img src="{{ asset('storage/images/logo10.png') }}" alt style="display: block;" width="75"></a>
</td>


<td align="left" class="esd-block-text es-p20t es-p10b es-m-txt-c p-3">



<h1 style="font-size: 46px; line-height: 100%;">AulabPost</h1>
...
<h3 class=" align-content-center ">ricevuta da: {{ $info['email'] }}</h3>



<tr>
<td align="left" class="esd-block-text es-p5t es-p5b p-2">
...
<div align="center">
<button class="btn btn-warning"><a style="text-decoration: none; color:black " href="http://127.0.0.1:8000/admin/dashboard">Link alla dashboard</a></button>
...
<td align="center" class="esd-block-text es-p35b p-2">

<p>© 2023-2024 The Coders</p>
</td>
</tr>
