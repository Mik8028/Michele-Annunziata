            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <p>
                            The Aulab Post offre articoli di qualità su una vasta gamma di argomenti, dalla tecnologia
                            alla cultura. Esplora il nostro sito per contenuti informativi e coinvolgenti.
                        </p>
                    </div>
                    <!-- Grid column -->
